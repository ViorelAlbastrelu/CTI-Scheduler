...
namespace CTISchedule
{
    public partial class Informatii : Form
    {
        ...
        private void tabInformatii_DrawItem(object sender, DrawItemEventArgs e)
        {
            Graphics g = e.Graphics;
            Brush _textBrush;

            // Get the item from the collection.
            TabPage _tabPage = tabInformatii.TabPages[e.Index];

            // Get the real bounds for the tab rectangle.
            Rectangle _tabBounds = tabInformatii.GetTabRect(e.Index);
