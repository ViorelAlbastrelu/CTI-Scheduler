namespace CTISchedule
{
	partial class Scheduler
	{
		...
		private void InitializeComponent()
		{
			...
			this.profesorTableAdapter = new CTISchedule.ctischeduleDataSetTableAdapters.ProfesorTableAdapter();
			...
			this.orarToolStripMenuItem.Size = new System.Drawing.Size(125, 22);
			...
			this.moduleProfesorContainer.Controls.Add(this.txtPrenumeProfesor);
			...
			// txtIdProfesor
			// 
			this.txtIdProfesor.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.profesorBindingSource1, "Id", true));
			...
			// txtPrenumeProfesor
			// 
			this.txtPrenumeProfesor.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.profesorBindingSource1, "Prenume", true));
			this.txtPrenumeProfesor.Location = new System.Drawing.Point(36, 128);
			...
			// panelDiscipline
			// 
			this.panelDiscipline.Controls.Add(this.moduleDiscplinaContainer);
			...
			// txtIdDisciplina
			// 
			this.txtIdDisciplina.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.disciplinaBindingSource, "Id", true));
			...
			this.txtIdDisciplina.Size = new System.Drawing.Size(92, 20);
			...
			this.label13.Text = "Identificator";
			// 
			// btnSaveDisciplina
			// 
			this.btnSaveDisciplina.Location = new System.Drawing.Point(36, 394);
			this.btnSaveDisciplina.Name = "btnSaveDisciplina";
			this.btnSaveDisciplina.Size = new System.Drawing.Size(156, 23);
			this.btnSaveDisciplina.TabIndex = 9;
			...
			// btnDeleteDisciplina
			// 
			this.btnDeleteDisciplina.Location = new System.Drawing.Point(118, 365);
			this.btnDeleteDisciplina.Name = "btnDeleteDisciplina";
			this.btnDeleteDisciplina.Size = new System.Drawing.Size(75, 23);
			this.btnDeleteDisciplina.TabIndex = 8;
			this.btnDeleteDisciplina.Text = "Sterge";
			this.btnDeleteDisciplina.UseVisualStyleBackColor = true;
			this.btnDeleteDisciplina.Click += new System.EventHandler(this.btnDeleteDisciplina_Click);
			// 
			// btnCancelDisciplina
			// 
			this.btnCancelDisciplina.Location = new System.Drawing.Point(37, 365);
			this.btnCancelDisciplina.Name = "btnCancelDisciplina";
			this.btnCancelDisciplina.Size = new System.Drawing.Size(75, 23);
			this.btnCancelDisciplina.TabIndex = 7;
			...
			// txtCredite
			// 
			this.txtCredite.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.disciplinaBindingSource, "Credite", true));
			...
			// cboxDAnStudiu
			// 
			this.cboxDAnStudiu.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.disciplinaBindingSource, "An", true, System.Windows.Forms.DataSourceUpdateMode.Never, null, "N0"));
			...
			// txtNumeDisciplina
			// 
			this.txtNumeDisciplina.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.disciplinaBindingSource, "Nume", true));
			...
			this.label10.Text = "Anul de studiu";
			// 
			// dgvDiscipline
			// 
            ...
            this.crediteDataGridViewTextBoxColumn});
			this.dgvDiscipline.DataSource = this.disciplinaBindingSource;
			...
			// 
			// crediteDataGridViewTextBoxColumn
			// 
			this.crediteDataGridViewTextBoxColumn.DataPropertyName = "Credite";
        ...
        private ctischeduleDataSet ctischeduleDataSet;
        private System.Windows.Forms.BindingSource profesorBindingSource1;
        private ctischeduleDataSetTableAdapters.ProfesorTableAdapter profesorTableAdapter;
